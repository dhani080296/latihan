...
class Kelas_model extends CI_Model {
    ...
    public function __construct() {
     ...
     public function load_form_rules_tambah(){
        ...
        $form_rules=array(array('field'=>'id_kelas','label'=>'Kode kelas',
            'rules'=>"required|numeric|exact_length[2]|is_unique
                [$this->db_tabel.id_kelas]|callback_is_id_kelas_exist"),
            array('field'=>'kelas','label'=>'Nama Kelas',
    ...
    public function buat_tabel($data){
        ...
        foreach ($data as $row){
            $this->table->add_row(
                    ...
                    anchor('kelas/hapus/'.$row->id_kelas,'Hapus',array('class'=>'delete',
