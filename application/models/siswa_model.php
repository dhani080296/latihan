...
class Siswa_model extends CI_Model{
    ...
    public function cari_semua($offset){
        ...
        return $this->db->select('siswa.nis,siswa.nama,kelas.kelas')
            ->from($this->db_tabel)->join('kelas', 'kelas.id_kelas = siswa.id_kelas')
 ...
 anchor('siswa/hapus/'.$row->nis,'Hapus',array('class'=>'delete','onclick'=>
    ...
    private function load_form_rules_tambah(){
        $form = array(
            ...
            array( 
                'field'=>'nama',
                'label'=>'Nama',
                'rules'=>'required|max_length[50]|callback_is_nama_exist'
                ),
            array('field'=>'id_kelas',
                  'label'=>'Kelas',
                'rules'=>'required'),
        );
        return $form;
    ...
    public function load_form_rules_edit(){
      ...
      $form=array(
          array(
              'field'=>'nis',
              'label'=>'NIS',
              'rules'=>"required|numeric|exact_length[4]|callback_is_nis_exist"
          ),
          array(
              'field'=>'nama',
              'label'=>'Nama',
