...
$form=array(
    'nis'=>array(
        ...
        'size'=>'30',
        'class'=>'form_field',
        'value'=>  set_value('nis',  isset($form_value['nis'])
                ? $form_value['nis']:'')
    ),
    'tanggal'=>array(
        'name'=>'tanggal',
        'size'=>'30',
        'class'=>'form_field',
        'value'=>  set_value('tanggal',  isset($form_value['tanggal'])
                ? $form_value['tanggal']:''),'onclick'=>"displayDatePicker('tanggal')"
    ),
    'submit'=>array(
        'name'=>'submit',
        'id'=>'submit',
...
<p>
    ...
    <a href="javascript:void(0);" onclick="displayDatePicker('tanggal');">
        <img src="<?php echo base_url('asset/images/icon_calendar.png'); ?>"
...
<p>
    ...
    <?php echo form_radio('absen','S',  set_radio('absen','S',  isset($form_value['absen'])
     ...
     <?php echo form_radio('absen','I',  set_radio('absen','I',  isset($form_value['absen'])
            && $form_value['absen']== 'I' ? TRUE:FALSE));?>(IZin)
